 ...
 * 
 * Adapted for nbang.github.io to run in browser without build step.
 */
...
(function (global) {
    ...
    // Constants for Can Chi calculation
    const TEN_CAN = ["Giáp", "Ất", "Bính", "Đinh", " Mậu", "Kỷ", "Canh", "Tân", "Nhâm", "Quý"];
    const TWELVE_CHI = ["Tý", "Sửu", "Dần", "Mão", "Thìn", "Tị", "Ngọ", "Mùi", "Thân", "Dậu", "Tuất", "Hợi"];
